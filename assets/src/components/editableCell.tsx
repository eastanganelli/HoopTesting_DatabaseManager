...
type editableCellType = EditableCellProps<materialType | specificationType | configurationType | operatorType | standardType>;

const EditableCell: FunctionComponent<editableCellType> = ({ title, editable, children, dataIndex, record, handleSave, ...restProps }) => {
